...
public class PartieDominos {
    ...
    public static void main(String[] args) {
        ...
        AlgoJoueur[0] = new Minimax(HeuristiquesDominos.hblanc, jBlanc, jNoir, 3); // Il faut remplir la méthode !!!
        AlgoJoueur[1] = new AlphaBeta(HeuristiquesDominos.hnoir, jNoir, jBlanc, 9); // Il faut remplir la méthode !!!
